...
int _dissolve_sinks_uint16(unsigned short* basin, unsigned char* re_dir, float* dem, unsigned long long* sink_idxs, unsigned short* colors,
	unsigned short sink_num, unsigned short min_sink, int cols, unsigned long long QUENE_SIZE) {
...
int _dissolve_sinks_uint8(unsigned char* basin, unsigned char* re_dir, float* dem, unsigned long long* sink_idxs, unsigned char* colors,
	unsigned char sink_num, unsigned char min_sink, int cols, unsigned long long QUENE_SIZE) {
